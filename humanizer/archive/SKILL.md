...
description: |
  ...
  inflated symbolism, promotional language, vague attributions, rule of three,
  passive voice, negative parallelisms, filler phrases, and other formulaic patterns.
license: MIT
...
### 6. Negative Parallelisms and Tailing Negations
...
### 15. Knowledge-Cutoff Disclaimers and Speculative Gap-Filling
...
### 21. Signposting and Announcements
...
### 24. Manufactured Punchlines and Staccato Drama
...
### 26. Conversational Rhetorical Openers
...
- **Formal or academic vocabulary.** AI overuses certain trendy or formulaic terms, not all fancy words. Don't flatten a precise word just because it sounds brainy.
...
When in doubt, look for **clusters** of tells, not isolated ones. A single rhetorical habit means nothing; stacked formulaic phrasing, rule-of-three cadence, and a generic "Conclusion" section are stronger evidence.
...
2. Write a **draft rewrite**. Check that it reads naturally aloud, varies sentence length, prefers specific details and direct constructions, and keeps the appropriate register.
3. Ask: **"What makes the below so obviously AI generated?"** Answer briefly with any remaining tells.
4. Revise into a **final rewrite** that addresses them and removes any remaining formulaic tells.
